...
export class AjoutChef extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event) {
        ...
        console.log(data)
        axios.post("/chef", data, { // receive two parameters: endpoint url ,form data 
        })
            ...
            <form onSubmit={this.handleSubmit} encType="multipart/form-data" method="post">
                <div className="form-row">
                    ...
                    <div className="col-5 mb-2">
                        <input type="text" onChange={this.handleChangeNom} className="form-control" placeholder="Nom chef" />
                    </div>
